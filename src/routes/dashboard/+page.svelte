<script lang="ts">
    ...
    const presenceData = async (userID: string) => {
        const { data } = await axios.get(`https://presence.shuttle.rip/user/${userID}`);
        return data;
    };
        ...
        {#if data.status === 403}
            <div class="banned">
                <h4 class="banned-message">
                    ...
                    <a href="https://discord.gg/shuttlebio" class="banned-link">support Discord</a>.
                </h4>
            </div>
        {:else}
            ...
            <form id="edit-form" class="edit-form" action="?/edit" method="POST">
                <div class="form-group">
                    <label for="title" class="label title">Username</label>
                    <input name="slug" id="title" class="input" placeholder="Username" value={data.body.slug} />
                </div>
                <div class="form-group">
                        ...
                        <div class="right-column">
                            <div class="image-preview-wrapper">
                                {#if presence?.data.discord_user.avatar}
                                    <img
                                        src="https://cdn.discordapp.com/avatars/{presence.data
                                            .discord_user.id}/{presence.data.discord_user
                                            .avatar}.png"
                                        class="image-preview"
                                        alt="avatar"
                                    />
                ...
                <div class="form-group">
                    ...
                    <button on:click={toggleSocialDropdown} class="dropdown-button">Select Social</button>
                                ...
                                <div class="social-input-container">
                                    ...
                                    <a title={getSocial(social).url.replace('https://', '')}>
                                        <svelte:component
                                            ...
                                            height="24"
                                            width="24"
                                            style="filter: drop-shadow(0 0 0.2rem {getSocial(social).color});"
                                        />
                                    </a>
                                    <div class="input-link-preview">
                                        <span>{getSocial(social).url.replace('https://', '')}</span>
                                        {#if data.body.socials && Array.isArray(data.body.socials)}
                                            <input
                                                name="social_{social}"
                                                class="input"
                                                placeholder={social}
            ...
            .form-group {
                ...
                .social-input-container {
                    ...
                    a {
                        ...
                        height: 24px;
                        border-radius: 50%;
                        background-color: var(--color-primary); // Change to your preferred color
                    ...
                    .input-checkbox {
                        ...
                        &:checked {
                            &::before {
                                ...
                                color: green; /* Checkmark color when checked */
                            }
                        }
